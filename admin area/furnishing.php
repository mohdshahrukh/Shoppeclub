...
<form method="POST"  action="furnishing.php" enctype="multipart/form-data">
<table width="700px" height="650px" align="center" border='1px' >

<tr align= "center">
<td colspan="2" height=80px><h1>Insert Home's Furnishing</h1></td>
</tr>
...
if(isset($_POST['insert_product']))
{
	...
	{   
		...
		$insert_product = "insert into furnishing (cat_id,price_id,date,product_title,product_img1,product_img2,product_img3,product_img4,product_offer,product_cost,product_size,product_desc,product_keywords,tablename)
		                            values ('$product_cat','$product_price',NOW(),'$product_title','$product_img1','$product_img2','$product_img3','$product_img4','$product_offer','$product_cost','$product_size','$product_desc','$product_keywords','furnishing')";
