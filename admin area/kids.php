...
<form method="POST"  action="kids.php" enctype="multipart/form-data">
<table width="700px" height="650px" align="center" border='1px' >

<tr align= "center">
<td colspan="2" height=80px><h1>Insert Kid's Product</h1></td>
</tr>
...
if(isset($_POST['insert_product']))
{
	...
	if($product_title=='' OR $product_cat=='' OR $product_price=='' OR $product_cost==''OR $product_size=='' OR $product_desc=='' OR $product_keywords=='' OR $product_img1=='')
	{
	...
	{   
		...
		$insert_product = "insert into kids (cat_id,price_id,date,product_title,product_brand,product_img1,product_img2,product_img3,product_img4,product_offer,product_cost,product_size,product_desc,product_keywords,tablename)
		values ('$product_cat','$product_price',NOW(),'$product_title','$product_brand','$product_img1','$product_img2','$product_img3','$product_img4','$product_offer','$product_cost','$product_size','$product_desc','$product_keywords','kids')";
