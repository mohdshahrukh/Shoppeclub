...
<form method="POST"  action="mob.php" enctype="multipart/form-data">
...
<tr>
<td align="right"><b>Product Battery</b></td>
<td><input type="text" name="battery" size="50"/></td>
</tr>
<tr>
<td align="right"><b>Product Camera</b></td>
<td><input type="text" name="camera" size="50"/></td>
</tr>
<tr>
...
if(isset($_POST['insert_product']))
{
	...
	$product_battery=$_POST['battery'];
	$product_camera=$_POST['camera'];
	...
	if($product_title=='' OR $product_cat=='' OR $product_price=='' OR $product_cost==''OR $product_size==''OR $product_color==''OR $product_ram==' 'OR $product_rom==''OR $product_battery==''OR $product_camera==''OR $product_desc=='' OR $product_keywords=='' OR $product_img1=='')
	{
