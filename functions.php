...
$db = mysqli_connect("localhost","root","","shoppeclub");
...
function vart(){
	...
	if(isset($_GET['add_cart'])){
		...
		$table=$_GET['table'];
		$insert_pro="insert into cart (ip,p_id,tabl) values ('$ip','$pro_id','$table')";
...
function cart()
{
	...
	if(isset($_GET['add_cart'])){
		...
		echo "<script>alert('detail');</script>";
			...
			$insert_pro="insert into cart (p_id,ip,price,size) values ('$pro_id','$ip','$cost','$size')";
		    $run_pro = mysqli_query($db,$insert_pro);
			echo "<script>window.open('detail.php','_self')</script>";
			echo "<script>alert('detail');</script>";
...
function total_price(){
	...
	while($p_price=mysqli_fetch_array($run_price)){
		$pro_id=$p_price['p_id'];
		$table=$p_price['tabl'];
		$pro_price= "select * from $table where id='$pro_id'";
...
function total_rice(){
	...
	while($p_price=mysqli_fetch_array($run_price)){
		...
		while($pp_price = mysqli_fetch_array($run_pro_price)){
			...
			$product_cost = array($pp_price['product_offer']);
			$values = array_sum($product_cost);
